  ...
  return (
    <section className="px-6 py-20 bg-surface">
      <PopIn className="flex flex-col items-center text-center gap-5 max-w-lg mx-auto">
        ...
        <div className="flex flex-col items-center gap-3 mt-4 pt-6 border-t border-border w-full">
          <p className="text-[11px] uppercase tracking-[0.15em] text-muted font-semibold">Follow us</p>
          <div className="flex items-center gap-3">
            <a href="https://www.instagram.com/ucdpantry/" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
              className="w-9 h-9 rounded-full border border-border text-muted hover:border-pantry-green/40 hover:text-pantry-green flex items-center justify-center transition-colors duration-200">
