...
export default function InventoryCard({
  ...
  return (
    <article
      ...
      className={[
        "relative flex rounded-2xl overflow-hidden select-none transition-all duration-200 h-full",
        "border",
        isOut
    ...
    >
      ...
      <div
        className={[
          "flex flex-col p-3 flex-1 min-w-0 transition-colors duration-200 overflow-hidden",
